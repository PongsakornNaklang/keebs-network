...
const pcbOptions = [
    ...
    { value: "via", label: "VIA support" },
    { value: "qmk", label: "QMK support" },
...
const CreateIC = () => {
    ...
    return (
        <div>
            <form ref={formRef} onSubmit={onPublish}>
                <Stack spacing={4}>
                    <Stack className="flex md:flex-row lg:flex-row justify-between">
                        ...
                        <div className="flex gap-x-4">
                            ...
                            <Button colorScheme="purple" variant='solid' leftIcon={<CloudArrowUp size={16} weight="fill" />} type="submit"> Publish</Button>
                        </div>
                    </Stack>
                    <Stack direction={"row"}>
